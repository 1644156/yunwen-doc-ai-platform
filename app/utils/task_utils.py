...
_NODE_NAME_TO_CN: Dict[str, str] = {
    ...
    "node_join": "多路搜索合并",
    # --- Routing + CRAG 节点 ---
    "node_query_routing": "查询意图路由",
    "node_search_bm25": "BM25检索",
    "node_search_graph_rag": "知识图谱检索",
    "node_crag": "检索质量评估",
    "node_query_rewrite": "查询重写",
    "node_crag_re_retrieve": "重检索",
    "node_crag_supplement": "补充搜索",
    "node_answer_refuse": "拒绝回答",
    "node_rerank_after_supplement": "补充重排序",
}
