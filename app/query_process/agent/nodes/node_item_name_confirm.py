...
def step_6_deal_list(item_results, history_chats, rewritten_query):
    """
    根据集合类型中数据，返回部分状态 dict
    :param item_results: {confirmed_item_names: [...], options_item_names: [...]}
    :param history_chats: 历史聊天记录
...
def node_item_name_confirm(state):
    ...
    #6. 根据item_name确定的集合返回部分状态
    result = step_6_deal_list(item_results, history_chats, rewritten_query)
    #7. 记录本次的聊天对话
    save_chat_message(
